/*
  ...
  We will overload it and add it to the class. s
*/
#include <iostream>
#include <vector>
#include "Mystring.h"
...
int main(){
  ...
  b = "This is a test"; // b.operator=("This is a test"); in backend
                        // Assignment Example (as b already exists)
                        ...
                        // so first overloaded constructor will be called to create temporary
                        // object and then copy assignment will be called to assign that 
                        // temporary object. 
