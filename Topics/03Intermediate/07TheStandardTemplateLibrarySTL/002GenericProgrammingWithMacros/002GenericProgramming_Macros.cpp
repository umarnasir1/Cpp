/*
  Generic Programming with Macros
    ...
    MACROS
    Better way to use constants
    
    Example1: Generic Programming - macros with arguments (#define)
      A function to determine the max of 2 integers 
    Example2: Generic Programming - An e.g. with Generic programming (OBS! beaware eg)
      Square of a number. 
...
int main (){
  ...
  // -----------
  // max function - without generic programming
  ...
  // ----Exameples 1 - Generic Programming
  ...
  // ----Exameples 2 - Generic Programming
  // macros with arguments (#define)
  // #define SQUARE(a) a*a
  int result{0};
  result = SQUARE(5); 
...
// int
int max(int a, int b){
  return (a > b) ? a : b; // conditional operator - if true a is returned
}
