...
int main (){
  ...
  // Display the elements in vector1 using the at() method as well as its size using the size() method
  cout << "Vector1" << endl;
  cout << "Element at position 0: " << vector1.at(0) << endl;
  cout << "Element at position 1: " << vector1.at(1) << endl;
  ...
  // Display the elements in vector2 using the at() method as well as its size using the size() method
  cout << "\nVector2" << endl;
  cout << "Element at position 0: " << vector2.at(0) << endl;
  cout << "Element at position 1: " << vector2.at(1) << endl;
  ...
  // Display the elements in vector_2d using the at() method
  cout << "\nVector_2D" << endl;
  cout << "Element at row 0: " << vector_2d.at(0).at(0) << " " << vector_2d.at(0).at(1) << endl;
  cout << "Element at row 1: " << vector_2d.at(1).at(0) << " " << vector_2d.at(1).at(1) << endl;
