...
Mystring &Mystring::operator=(const Mystring &rhs){
    ...
    if (this == &rhs) // checking for self assignment p1=p1; where p1 and p2 are objects
    ...
    // this is pointer to current object and pointer holds address. (s2=s1; s2.operator= (s1); s2 current object here and s1 is rhs)
    ...
    //  function definition, it is expecting reference to object.
    ...
    delete [] str; // OR delete[] this->str; [] as we are deleting array of characters
    ...
    str = new char [std::strlen(rhs.str) + 1]; // rhs.str as there is str in lhs(this) also and we are accessing str of rhs.
