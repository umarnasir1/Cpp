/*
  Stream Manipulators - align and fill
    setw - field width - only applied to next data item on the stream; right justtification by default
    justification
      left
      right
    setfill -only applies when we have fieldwidth associated with it;
