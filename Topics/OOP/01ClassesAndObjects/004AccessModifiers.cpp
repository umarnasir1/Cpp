...
public: //Since these methods are member methods, they have access to the balance and can update its value.
  bool deposit (double amount){balance += amount; cout << "Total Balance: " << balance << endl;}
  bool withdraw (double amount){balance -= amount; cout << " Total Balance: " << balance << endl;}
};
...
int main (){
  ...
  // cout << bjarne.health << endl; // Compiler error - as we are trying to use the variable from outside the class.
